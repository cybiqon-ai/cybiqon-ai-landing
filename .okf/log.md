...
* **Content**: ninth lab post, `kolam-rangoli-mandala-indian-art-puzzle-game`, the first of a
  RevenueCat Shipaton 2026 series on `products/curvved`. Five inline SVGs generated by the
  game's own kolam and ornament code; 388 KB live HTML, the heaviest lab page so far. See
  [Lab](/content/lab.md). `llms.txt --check`: 9 lab posts · 8 sections · 47 links · 51 routes
  covered · 12.2 KB.
