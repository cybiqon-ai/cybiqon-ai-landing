...
| `data/legal/{llmbytes,meflow,vitaloop,lumina,orbitone,curvved,mapwit,page-arcade}.ts` | privacy and terms, as a `Block` discriminated union (prose / checklist / deflist / table / contact) rather than MDX or raw HTML |
