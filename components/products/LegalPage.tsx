...
/**
 * Shared shell for /products/<slug>/privacy and /products/<slug>/terms.
 *
...
export default function LegalPage({
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: app.name, item: `${siteUrl}/products/${app.slug}` },
      {
        "@type": "ListItem",
        position: 4,
        name: title,
        item: `${siteUrl}/products/${app.slug}/${kind}`,
      },
    ],
  };
