...
const WhatsAppWidget = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      ...
      {showBubble && (
        <div
          className={`relative rounded-lg bg-white px-4 py-2 shadow-lg transition-opacity duration-500 ${
        ...
        >
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-full">
            <div className="h-0 w-0 border-y-[6px] border-l-[8px] border-y-transparent border-l-white"></div>
          </div>
        </div>
      )}
